...
const BookingForm = ({currentUser, paymentIntent}: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='grid grid-cols-1 gap-5 rounded-lg border-slate-300 p-5'>
        ...
        <div className='flex justify-end'>
            <button disabled= {isLoading} type='submit' className='bg-blue-600 text-white p-2 font-bold hover:bg-blue-500 text-md disabled:bg-gray-500'>{isLoading ? "Saving" : "Confirm Booking"}</button>
        </div>
    </form>
  )
}
