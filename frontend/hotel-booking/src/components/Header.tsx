            ...
            <div className="container mx-auto flex justify-between">
                ...
                <span className="flex space-x-2">
                    {isLoggedIn ? (
                        ...
                        <Link to="/sign-in" className='flex bg-slate-300 items-center text-blue-600 font-bold px-3 hover:bg-gray-100 ml-auto'>Sign In</Link>
                    )}
                </span>
            </div>
        </div>
