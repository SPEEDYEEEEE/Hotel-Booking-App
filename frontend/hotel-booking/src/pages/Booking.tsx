...
import BookingDeatilSummary from '../components/BookingDeatilSummary';
...
const Booking = () => {
    ...
    if (!stripePromise) {
        // Handle the case where stripePromise is not available
        return <div>Error: Stripe is not initialized</div>;
    };

  return (
    <div className='grid md:grid-cols-[1fr_2fr]'>
        <BookingDeatilSummary checkIn={search.checkIn} checkOut={search.checkOut} adultCount={search.adultCount} childCount={search.childCount} numberOfNights={numberOfNights} hotel={hotel}/>
